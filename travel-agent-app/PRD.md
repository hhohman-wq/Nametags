...
**One-liner:** A social-style feed of real, bookable travel deals for flexible travelers — scroll trips like a social feed, watch prices, and book when the moment is right.
...
### Goals (v1)
1. A **deal feed**: an infinitely scrollable, personalized feed of real trips with live prices — flash sales, mistake fares, weekend getaways, "leaving soon" trips.
2. **Flexible discovery**: filter the feed by *constraints, not destinations* — budget, dates ("next weekend"), home airport, vibe (beach/city/ski).
3. **Price watching**: follow any trip in the feed; get push alerts on drops; buy/wait guidance.
4. **Path to booking**: every card is bookable — via affiliate/deep-link handoff in v1, native flight booking (Duffel) in v2.
...
|---|---|---|
| **The Flexible Opportunist** (primary) | 25–40, remote-work-flexible, 3–6 trips/yr, budget-aware | "I could go somewhere next week — show me what's worth it from my airport." |
